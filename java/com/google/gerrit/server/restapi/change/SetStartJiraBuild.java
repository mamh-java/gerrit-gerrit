...
@Singleton
public class SetStartJiraBuild
  ...
  @Inject
  SetStartJiraBuild(BatchUpdate.Factory updateFactory, WorkAddMessageOp.Factory opFactory) {
  ...
  public Response<String> apply(ChangeResource rsrc, Input input)
    ...
    try (BatchUpdate bu = updateFactory.create(rsrc.getProject(), rsrc.getUser(), TimeUtil.nowTs())) {
      ...
      bu.addOp(rsrc.getChange().getId(), opFactory.create("start_CheckJira", input));
